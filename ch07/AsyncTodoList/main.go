...
func main() {
	...
	// テンプレートを読み込む
	templates = template.Must(template.ParseGlob("ch07/AsyncTodoList/templates/*.html"))

	http.Handle("/static/",
		http.StripPrefix("/static/", http.FileServer(http.Dir("ch07/AsyncTodoList/static"))))
